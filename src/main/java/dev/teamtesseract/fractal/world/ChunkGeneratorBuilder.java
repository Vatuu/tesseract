...
import dev.teamtesseract.fractal.extensions.mixins.ChunkGeneratorSettingsInvoker;
...
public class ChunkGeneratorBuilder {
    ...
    public static class ChunkGeneratorSettingsBuilder {
        ...
        public RegistryKey<ChunkGeneratorSettings> register() throws FractalException {
            return FractalRegistry.getInstance().registerChunkGeneratorSettings(build(), getParent().name);
        }
