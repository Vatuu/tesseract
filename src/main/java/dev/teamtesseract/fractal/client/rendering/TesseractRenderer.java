...
public class TesseractRenderer {
    ...
    public void render(MatrixStack stack, VertexConsumerProvider vertexConsumers, float projectionDistance){
        VertexConsumer consumer = vertexConsumers.getBuffer(FractalRenderLayers.TESSERACT_VERTEX);
        ...
        consumer = vertexConsumers.getBuffer(FractalRenderLayers.TESSERACT_SIDE);
        for(int i = 0; i < 4; i++) {
